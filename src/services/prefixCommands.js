...
const PREFIX_SUPPORTED = new Map([
  ...
  ["level", { command: "level", dm: false, usage: "level [@user]", userOption: "user", defaultUser: true }],
  ...
  ["set_welcome_channel", { command: "set_welcome_channel", dm: false, admin: true, usage: "set_welcome_channel #channel", channelOption: "channel" }],
  ["set_goodbye_channel", { command: "set_goodbye_channel", dm: false, admin: true, usage: "set_goodbye_channel #channel", channelOption: "channel" }],
