...
function buildFunText() {
  return [
    ...
    "",
    "**Available in DMs**",
    "• `/help`, `/ping`, `/cat`, `/crazy`, `/mimic`",
    "• `/compliment`, `/roast`, `/8ball`, `/would_you_rather`",
    "• `/fact`, `/trivia`, `/poll`",
    "• `/summarize`, `/improve`, `/translate`, `/explain`",
    "• `/roblox_profile`, `/roblox_avatar`, `/roblox_game`",
    "",
    "**Server Only**",
    "• `/level`, `/leaderboard`, `/profile`, `/stats`, `/achievements`",
    "",
    "**System (Restricted)**",
