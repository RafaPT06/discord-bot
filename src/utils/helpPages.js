...
function buildFunText() {
  return [
    ...
    "• `/level [user]` — show XP and level progress",
    "• `/leaderboard` — server XP leaderboard",
    "• `/quote save/random/list` — server quotes",
    "• `/suggest add` — submit a suggestion",
    "• `/summarize`, `/improve`, `/translate`, `/explain` — AI text helpers",
    "• `/roblox_profile`, `/roblox_avatar`, `/roblox_game` — Roblox utilities",
    "• `/ping` — bot latency",
    "",
    "**Prefix Commands**",
    "These also work with the server prefix, usually `.`:",
    "• `.help`, `.ping`, `.cat`, `.crazy`",
    "• `.8ball <question>`, `.would_you_rather`, `.fact`, `.trivia`",
    "• `.mimic <text>`, `.compliment [@user]`, `.roast [@user]`",
    "• `.summarize <text>`, `.improve <text>`, `.translate <language> <text>`, `.explain <text>`",
    "• `.level [@user]`, `.leaderboard`, `.poll question | option1 | option2`",
    "• `.quote random/list/save <text>`, `.suggest <text>`",
    "",
    "**System (Restricted)**",
