...
function buildFunText() {
  return [
    ...
    "• `/poll` — create a poll",
    "• `/edit_image <image> <prompt>` — edit an image with OpenAI",
    ...
    "`/help`, `/ping`, `/cat`, `/crazy`, `/mimic`, `/compliment`, `/roast`, `/8ball`, `/would_you_rather`, `/fact`, `/trivia`, `/poll`, `/roblox_profile`, `/roblox_avatar`, `/roblox_game`",
    "",
    "**Prefix Commands**",
