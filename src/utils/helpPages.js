...
function buildFunText() {
  return [
    ...
    "**Prefix aliases**",
    "• `.help` — same as `/help`",
    "• `.level [@user]` — same as `/level`",
    "• `.profile [@user]` — same as `/profile`",
    "• `.stats [@user]` — same as `/stats`",
    "• `.achievements [@user]` — same as `/achievements`",
    ...
    "• `.set_level_channel #channel` — set level-up channel",
    "",
    "**System (Restricted)**",
